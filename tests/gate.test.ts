...
import { computeGate, gateLibrary, NEEDS_VERIFICATION, selectPending, summarizeLibrary, type GatedEntity } from "../extension/gate.ts";
import type { EntityMeta, EntityWithVerifications, VerificationRecord } from "../extension/store.ts";
